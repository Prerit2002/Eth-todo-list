    ...
    return {
        opened(socket, extra) {
            ...
            socket.onMessage(async function onMessage(data) {
                ...
                let message;
                try {
                    message = common_1.parseMessage(data);
                }
                catch (err) {
                    ...
                    case common_1.MessageType.Subscribe: {
                        ...
                        const emit = {
                            next: async (result, args) => {
                                ...
                                await socket.send(common_1.stringifyMessage(nextMessage));
                            },
                            error: async (errors) => {
                                let errorMessage = {
                                    id,
                                ...
                                await socket.send(common_1.stringifyMessage(errorMessage));
                            },
                            complete: async (notifyClient) => {
                                ...
                                if (notifyClient)
                                    await socket.send(common_1.stringifyMessage(completeMessage));
                            },
                        };
                        let execArgs;
